...
| Date    | Start | End | Lectures topics  | Lectures | Quiz  | Programming Session | Optional Reaing |
|----------- | ----------- | ----------- | ----------- | ----------- |-----------|-----------|-----------|
